...
import bip39WalletFormatsIshmael from './bip39_wallet_formats_ishmael.json';
...
const startImport = (
  ...
  async function* importGenerator() {
    ...
    if (hd2.validateMnemonic()) {
      ...
      const searchPaths = searchAccounts ? bip39WalletFormatsElectrum : bip39WalletFormatsIshmael;
