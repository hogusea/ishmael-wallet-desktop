...
import io.hogusea.ishmael.components.segmentedcontrol.CustomSegmentedControlPackage
...
class MainApplication : Application(), ReactApplication {
    ...
    override fun onCreate() {
        super.onCreate()
        sharedPref = getSharedPreferences("group.io.hogusea.ishmael", Context.MODE_PRIVATE)
