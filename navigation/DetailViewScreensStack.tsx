...
import DeveloperDonation from '../screen/settings/DeveloperDonation';
...
const DetailViewStackScreensStack = () => {
  ...
  return (
    ...
    >
      ...
      />
      <DetailViewStack.Screen
        name="DeveloperDonation"
        component={DeveloperDonation}
        options={navigationStyle(getSettingsHeaderOptions('개발자 후원하기'))(theme)}
      />
      {/* <DetailViewStack.Screen
        name="DefaultView"
