  ...
  override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey: Any]?, context: UnsafeMutableRawPointer?) {
    ...
    override func application(_ application: UIApplication, continue userActivity: NSUserActivity, restorationHandler: @escaping ([UIUserActivityRestoring]?) -> Void) -> Bool {
      ...
      guard !activityType.isEmpty else {
        ...
        if ["io.hogusea.ishmael.receiveonchain", "io.hogusea.ishmael.xpub", "io.hogusea.ishmael.blockexplorer"].contains(activityType) {
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse, withCompletionHandler completionHandler: @escaping () -> Void) {
        ...
        let blockExplorer = userDefaultsGroup?.string(forKey: "blockExplorer") ?? "https://blockchain.mobick.info"
    ...
    @objc func showHelp(_ sender: Any) {
        if let url = URL(string: "https://github.com/hogusea") {
