...
describe('BlueElectrum', () => {
  ...
  it('ElectrumClient can test connection', async () => {
    assert.ok(!(await BlueElectrum.testConnection('wallet.mobick.info', 444, false)));
    assert.ok(!(await BlueElectrum.testConnection('wallet.mobick.info', false, 444)));
    ...
    assert.ok(await BlueElectrum.testConnection('wallet.mobick.info', '50001'));
    assert.ok(await BlueElectrum.testConnection('wallet.mobick.info', false, 443));
  });
